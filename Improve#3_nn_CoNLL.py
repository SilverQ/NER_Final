...
class CNN_BLSTM(object):
    ...
    def buildModel(self):
        ...
        # concat & BLSTM
        words = Bidirectional(LSTM(self.lstm_state_size,
                                    return_sequences=True,
                                    dropout=self.dropout,                        # on input to each LSTM block
                                    recurrent_dropout=self.dropout_recurrent     # on recurrent input signal
        ...
        words = Bidirectional(LSTM(self.lstm_state_size,
                                    ...
                                    dropout=self.dropout,                        # on input to each LSTM block
                                    recurrent_dropout=self.dropout_recurrent     # on recurrent input signal
                                   ), name="words_BLSTM_2")(words)
        char = Bidirectional(LSTM(self.lstm_state_size,
                                    return_sequences=True,
                                    dropout=self.dropout,                        # on input to each LSTM block
                                    recurrent_dropout=self.dropout_recurrent     # on recurrent input signal
        ...
        char = Bidirectional(LSTM(self.lstm_state_size,
                                    ...
                                    dropout=self.dropout,                        # on input to each LSTM block
                                    recurrent_dropout=self.dropout_recurrent     # on recurrent input signal
                                   ), name="char_BLSTM_2")(char)
        # casing = Bidirectional(LSTM(self.lstm_state_size,
        #                             return_sequences=True,
        #                             dropout=self.dropout,                        # on input to each LSTM block
        #                             recurrent_dropout=self.dropout_recurrent     # on recurrent input signal
